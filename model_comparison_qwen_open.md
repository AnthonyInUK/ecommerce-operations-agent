...
Generated at: 2026-06-11 20:03:42
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: |
| standard_gmv | Y | Y | Y | - | Y | - | Y | low | 36 ms |
| order_structure | Y | Y | Y | - | Y | - | Y | low | 85 ms |
| user_metric | Y | Y | Y | - | Y | - | Y | low | 6 ms |
| root_cause | Y | Y | Y | Y | Y | - | Y | low | 281 ms |
| dispatch_prompt | Y | Y | Y | Y | Y | - | Y | low | 51 ms |
| notify_decision | Y | Y | Y | Y | Y | Y | Y | medium | 101 ms |
| owner_priority | Y | Y | Y | Y | Y | Y | Y | medium | 100 ms |
| cause_priority | Y | Y | Y | Y | Y | Y | Y | medium | 299 ms |
...
- Action routing count: `5`
- Open judgement checks: `Y`
- Open check detail: `{"owner_priority": "routes=5, p0=4, has_platform=True, has_category=True, sorted=True"}`
- Model sensitivity: `medium`
- Cost note: 未接入 token usage 统计；当前只记录响应时间。
